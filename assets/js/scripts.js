...
(function($){
	...
	(function(){
		...
		$('.related_projects a.animate_fade').waypointSynchronise({
			container : '.related_projects',
			delay : 200,
			offset : 830,
			classN : "animate_sj_finished animate_fade_finished"
		});
...
//	})();
	...
	(function(){
		if($('.related_projects').length){
		 	var pb = $(".related_projects").owlCarousel({
		 		itemsCustom : $('.related_projects').hasClass('with_sidebar') ? [[1199,4],[992,4],[768,3],[480,3],[300,2]] : [[1199,6],[992,5],[768,4],[480,3],[300,2]],
		 		autoPlay : true,
		 		stopOnHover : true,
		 		slideSpeed : 600,
		 		addClassActive : true
