<section class="breadcrumbs">
    <div class="container">
        <ul class="horizontal_list clearfix bc_list f_size_medium">
            ...
            <li class="m_right_10 current"><a href="#" class="default_t_color">Manufacturer Product<i class="fa fa-angle-right d_inline_middle m_left_10"></i></a></li>
            <li><?php echo $viewManufacturerName->manufacturer_name;?></li>
        </ul>
    </div>
</section>
<div class="container">
    <h2 class="tt_uppercase m_bottom_20 color_dark heading1 animate_ftr" style="margin-top: 2em;">Most Popular <?php echo $viewManufacturerName->manufacturer_name;?> Products</h2>

    <section class="products_container clearfix m_bottom_25 m_sm_bottom_15">
              <?php foreach ($viewManufacturerProduct as $v_product){?>
