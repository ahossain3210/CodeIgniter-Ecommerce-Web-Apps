                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown hidden-phone">
                                ...
                                <ul class="dropdown-menu messages">
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="avatar"><img src="<?php echo base_url(); ?>adminAsset/img/avatar.jpg" alt="Avatar"></span>
                                            <span class="header">
                                                <span class="from">
                                                    Dennis Ji
                                                </span>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="<?php echo base_url(); ?>dashboard.html"><i class="icon-bar-chart"></i><span class="hidden-tablet">Dashboard</span></a></li>	
                            <?php
                            $access_level = $this->session->userdata('access_level');
                            if ($access_level == 1 || $access_level == 2 || $access_level == 3) {
                                ?>

                                <li><a href="<?php echo base_url(); ?>add-category.html"><i class="icon-envelope"></i><span class="hidden-tablet">Add Category</span></a></li>
                                <li><a href="<?php echo base_url(); ?>add-manufacturer.html"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Manufacturer</span></a></li>
                                <li><a href="<?php echo base_url(); ?>add-product.html"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Product</span></a></li>
                                <li><a href="<?php echo base_url(); ?>add-blog.html"><i class="icon-eye-open"></i><span class="hidden-tablet">Add Blog</span></a></li>
                            <?php } ?>
                            <?php
                            $access_level = $this->session->userdata('access_level');
                            if ($access_level == 1 || $access_level == 2) {
                                ?>
                                <li><a href="<?php echo base_url(); ?>manage-category.html"><i class="icon-tasks"></i><span class="hidden-tablet">Manage Category</span></a></li>
                                <li><a href="<?php echo base_url(); ?>manage-manufacturer.html"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Manufacturer</span></a></li>
                                <li><a href="<?php echo base_url(); ?>manage-product.html"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Product</span></a></li>
                                <li><a href="<?php echo base_url(); ?>manage-blog.html"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Blogs</span></a></li>
                                <li><a href="<?php echo base_url(); ?>manage-order.html"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Order</span></a></li>
                            <?php } ?>
